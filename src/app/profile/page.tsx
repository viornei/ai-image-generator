...
import { Button, Input, VStack, Avatar, Text, Flex, Spinner } from "@chakra-ui/react";
...
export default function Profile() {
        ...
        const fetchUser = async () => {
            ...
            if (userError) {
                ...
                localStorage.setItem(
                    "negativePrompt",
                    userData.default_negative_prompt || "",
                );
            }
        };
    ...
    if (!user) return  <Flex width="100%" mt={10} justify="center"><Spinner size="lg" color="blue.500" /></Flex> 
